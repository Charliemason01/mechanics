...
function updateGameArea () {
    ...
    if(myGameArea.frameNo == 4 || everyinterval(Math.floor((Math.random() * 70) + 100))){
        var oHeight = Math.floor(Math.random() * 140) + 40;
    ...
    if (myGameArea.key && myGameArea.key == 87) {myGamePiece.speedY = -18; }
    if (myGameArea.key && myGameArea.key == 83) {myGamePiece.speedY = +18; }
